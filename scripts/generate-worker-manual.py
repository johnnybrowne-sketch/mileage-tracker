...
def build_manual():
    ...
    story.append(feature_table([
        ...
        ("Upload Paper Sheet", "Upload a JPG, PNG, WEBP, or PDF paper mileage sheet. AI draft conversion may be available when credits are active."),
    ...
    story.append(p("Use Upload Paper Sheet when mileage was written on a paper form or needs manual review. Uploads go to admin immediately. When AI conversion is available, the app can create editable draft rows from the uploaded sheet."))
    story.append(numbered([
        ...
        "If Convert With AI is available, use it to create editable draft rows.",
